// this was derived experimentally
// with no idea how it works out as this...
...
function queueStrums(sequenceN, blockStartTime, chordIndex, precacheTime) {
    ...
    // if wit was only generating the next strum 200 ms ahead of the current time,
    // it might be falling behind, so increase the precache time
    ...
    // it try to main a constant time between when the strum
